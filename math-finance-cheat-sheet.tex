...
\end{tabular}
\end{center}
\emph{P means the process stays positive, MR means $r_t$ is mean-reverting. Closed form solutions for bond prices and European options exist for all models except for $\dagger$, which desribes the evoluation of $d\log(r_t)$ instead of $dr_t$.}
